...
with SdkCompiler(disable_version_check=True) as compiler:
    ...
    artifact_path = compiler.compile(
        "./src",
        "bw_sync_layout.csl",
        "--arch wse3 --fabric-dims=762,1172 --fabric-offsets=156,153 --params=width:448,height:448,pe_length:4096 --params=C0_ID:0 --params=C1_ID:1 --params=C2_ID:2 --params=C3_ID:3 --params=C4_ID:4 -o=latest --memcpy --channels=16 --width-west-buf=152 --width-east-buf=152 ",
        "."
    )
